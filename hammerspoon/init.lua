...
hs.hotkey.bind('alt-shift', ',', 'Bottom half', function() _move({0.5, 0.0, 1.0, 0.5}) end)
...
hs.hotkey.bind('alt', 'j', 'Sublime Text 2', function() _focusapp('Sublime Text 2') end)
...
hs.hotkey.bind('alt', 'return', 'iTerm2', function() _focusapp('iTerm2') end)
